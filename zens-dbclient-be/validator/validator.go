...
// StrRequired returns true if a string value is not empty
func StrRequired(value string) bool {
	return value != ""
}
...
// NumRequired returns true if a number value is not zero
func NumRequired[T Number](value T) bool {
	return value != 0
}
